...
class Notice {
    ...
    public function display_notice() {
        $route = new Route;
        $plugin_basename = plugin_basename(dirname(__FILE__) . '/themes-assistant.php');
        ...
        if (!get_user_meta(get_current_user_id(), $dismissed_notice)) {
            ...
            <div class="notice notice-info is-dismissible">
                <p>
                    <?php echo esc_html__('Thank you for choice the ThemesAssistant plugin! If you find it helpful, please consider leaving us a feedback.', 'themes-assistant') ?></a>
                </p>
