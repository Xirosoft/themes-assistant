...
<div class="portfolioITems style-4 px-3 ">
        <?php if( 'yes' === $settings['show_filter'] ){ ?>
        <div class="ui-group filters filter-v4">
            ...
            <div class="protItem col-md-4 col-12 <?php echo esc_attr($item['portfolio_category']) ?>">
                <div class="port-item">
                    <div class="demoBox">
                        ...
                        <p class="pCat"><?php echo esc_html__($item['portfolio_description'], 'themes-assistant') ?></p>
                </div>
                    <div class="img-box">
                        <img 
                        
                            src="<?php if($thumbnail_url) echo esc_url($thumbnail_url); ?>" 
                            alt="<?php echo esc_html__($item['portfolio_title'], 'themes-assistant') ?>"
    					...
    					<a data-fancybox="gallery" class="port_popup" area-label="<?php echo esc_html__($item['portfolio_title'], 'themes-assistant') ?>" href=" <?php echo esc_url($item['portfolio_image']['url']); ?> " <?php echo  $target . $nofollow; ?> aria-hidden="false"> 
                            ...
                            <?php elseif( $settings['icon_type'] == 'iconclass'):?>
                                ...
                                <span class="icon">
                                    <img src="<?php echo esc_url($settings['image']['url']); ?>" alt="<?php echo esc_html__($item['portfolio_title'], 'themes-assistant') ?>" class="img-icon" width="68" height="68">
                                </span>
                            <?php endif;?>    
                        </a>
                    </div>
                    <p class="portTag"><?php echo esc_html__($item['portfolio_category'], 'themes-assistant') ?></p>
                </div>
            </div>
            <?php } ?>
        </div>
