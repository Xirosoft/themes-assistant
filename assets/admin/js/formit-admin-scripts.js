jQuery(document).ready(function ($) {
    ...
    /**
     * themes-assistant submit action
     */
    ...
    function goEditURL(home_url) {
        ...
        var post_id = $('#post_ID').val();
            ...
            if (queryParams.post_type == 'themes-assistant') {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response) {
                    ...
                    link.href = url;
                    link.download = domainName+'-themes-assistant-form-data-'+randomInteger+'.csv';
    ...
    function submission_view_popup(data, prefix = '') {
        ...
        $('.post-type-themes-assistant').addClass('overlay')

        /**
         * popup close click event triger
         */
        $('.popup__close').on('click', function () {
            $('.post-type-themes-assistant').removeClass('overlay')
...
document.addEventListener('scroll', () => {
    ...
    const links = document.querySelectorAll('.post-type-themes-assistant .doc__nav a'); // Get all links
  ...
  document.querySelectorAll('.post-type-themes-assistant .doc__nav a').forEach(anchor => {
